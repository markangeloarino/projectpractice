    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("Could not load work experience."),
          ...
          children: [
            Expanded(
              ...
              child: Padding(
                ...
                child: Center(child: BuildLabel(text: "COMPANY NAME")),
              ),
            ),
            Expanded(
              flex: 4,
            ...
            Expanded(
              ...
              child: Padding(
                padding: const EdgeInsets.only(right: 8.0, bottom: 8.0),
                child: Center(child: BuildLabel(text: "POSITION")),
              ),
            ),
            Expanded(
              flex: 4,
              child: Padding(
                padding: const EdgeInsets.only(right: 8.0, bottom: 8.0),
                child: Center(
                  child: BuildLabel(text: "INCLUSIVE DATES\n(mm/dd/yyyy)"),
                ),
              ),
            ),
            Expanded(
        ...
        children: [
          Expanded(
            ...
            child: Padding(
              ...
              child: GreyTextField(controller: record.companyCtrl),
            ),
          ),
          Expanded(
            flex: 4,
            child: Padding(
              padding: const EdgeInsets.only(right: 8.0),
              child: GreyTextField(controller: record.addressCtrl),
            ),
          ),
          Expanded(
            flex: 4,
            child: Padding(
              padding: const EdgeInsets.only(right: 8.0),
              child: GreyTextField(controller: record.positionCtrl),
            ),
          ),
          Expanded(
            flex: 4,
          ...
          Expanded(
            flex: 3,
            child: GreyTextField(controller: record.statusCtrl),
          ),
        ],
      ),
    );
