...
class ScreenReviewApplications extends StatefulWidget {
  ...
  @override
  State<ScreenReviewApplications> createState() =>
      _ScreenReviewApplicationsState();
}
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Applied for: ${app['job_title']} at ${app['employer_name']}",
                                style: TextStyle(color: Colors.grey.shade700),
                              ),
                              Text(
                                "Email: ${app['email']} | Phone: ${app['contact_number'] ?? 'N/A'}",
                                style: TextStyle(
